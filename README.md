...
├── SETUP_GUIDE.md            ◀─── How to play
├── SAFETY.md                 ◀─── Player wellbeing
├── UNIVERSE.md               ◀─── Lore and world-building
├── IDENTITY_CARD_SPEC.md     ◀─── Card format specification
...
These games are intentionally difficult and intense:
...
ASPHYXIA exists because:

```
▪ AI alignment is hard to teach in the abstract
▪ Games create understanding through experience
▪ Philosophy comes alive under pressure
▪ The best lessons are earned, not given
```
